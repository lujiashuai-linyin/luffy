    ...
    <div class="register">
      <div class="register_box">
        ...
        <div class="inp">
          ...
          <input v-model = "password" autocomplete=‘new-password’ type="password" placeholder="登录密码" class="user">
          <input v-model = "re_password" autocomplete=‘new-password’ type="password" placeholder="确认密码" class="user">
          <div class="sms-box">
...
export default {
  ...
  methods:{
    ...
    smsHander(){
      ...
      // 3. 发送ajax
      this.$axios.get(`${this.$settings.HOST}/user/sms/valid/`,{params:
          {mobile:this.mobile,

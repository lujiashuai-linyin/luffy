# Generated by Django 3.2.13 on 2022-05-01 13:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brief', mdeditor.fields.MDTextField(blank=True, null=True, verbose_name='详情介绍')),
                ...
                ('price', models.DecimalField(decimal_places=2, default=0, help_text='如果这里填写的价格为0,则表示当前课程购买的时候，没有永久有效的期限', max_digits=6, verbose_name='课程原价')),
            ],
            options={
                'verbose_name': '专题课程',
